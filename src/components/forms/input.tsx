...
// Export Input props interface matching Stage 2 Check component
export interface InputProps extends  React.HTMLAttributes<HTMLDivElement>,  VariantProps<typeof checkVariants> {
  ...
  id?: string
  testId?: string  // Enhanced input specific props
...
const Input = React.forwardRef<  HTMLDivElement,
  InputProps
>(
  ({
  className,
  ...
  const effectiveVariant = error ? "error" : variant
    ...
    const inlineStyles: React.CSSProperties = {
      ...
      checkVariants({   variant: effectiveVariant, size }),
      className || ''
...
Input.displayName = "Input"export { Input, checkVariants }