...
export interface InputProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'size' | 'onChange'>, VariantProps<typeof searchVariants> {
 ...
 id?: string
 testId?: string // Stage 2 Search component interface
 fontFamily?: string
