/**
 * Image Component - Generated by Stage 3 Component Generator (Phase 2: Template-Driven)
 *
...
const designTokens = {
  ...
  },}// Image variants using CVA with design tokens
...
// Export Image props interface matching Stage 2 Image component
export interface ImageProps extends  React.HTMLAttributes<HTMLDivElement>,  VariantProps<typeof imageVariants> {
...
const Image = React.forwardRef<  HTMLDivElement,
  ImageProps
>(
  ({   className,
  variant,
  ...
  const handleClick = () => {
    ...
    const inlineStyles: React.CSSProperties = {
      ...
      imageVariants({   variant, size, layout }),
      className || ''
...
Image.displayName = "Image"export { Image, imageVariants }